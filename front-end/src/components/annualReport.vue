		...
		<div class="vlt-fullpage-slider" data-loop-top="" data-loop-bottom="" data-speed="450">
			...
			<div class="vlt-section pp-scrollable" data-anchor="Home">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<!--Ken Burn Effect-->
						<div class="vlt-section__ken-burn-background has-mobile-image"><img src="../../static/img/home.jpg" alt=""><img src="../../static/img/home-mobile.jpg" alt=""></div>
						<div class="container">
							<div class="row">
								<div class="col-lg-5">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.2s; animation-duration:700ms;">
										<h1 class="vlt-large-heading">QIMA<span class="has-accent-color">.</span></h1>
									</div>
									<div class="vlt-gap-15"></div>
									<!--Animated Block-->
			...
			<div class="vlt-section pp-scrollable" data-anchor="Projects">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<!--Projects-->
						<div class="vlt-section__projects-background"><img class="is-active" src="../../static/img/project-01.jpg" alt="" loading="lazy"><img src="../../static/img/project-02.jpg" alt="" loading="lazy"><img src="../../static/img/project-03.jpg" alt="" loading="lazy"></div>
						<div class="container">
							<div class="vlt-gap-100"></div>
							<!--Animated Block-->
							<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:0s; animation-duration:700ms;">
										...
										<div class="swiper-wrapper">
											<div class="swiper-slide">
												...
												<div class="vlt-timeline-item">
													<div class="row">
														<div class="col-xl-4"><img src="../../static/img/root/behance.png" alt="Behance" loading="lazy">
														</div>
												...
												<div class="vlt-timeline-item">
													<div class="row">
														<div class="col-xl-4"><img src="../../static/img/root/envato.png" alt="Envato" loading="lazy">
														</div>
												...
												<div class="vlt-timeline-item">
													<div class="row">
														<div class="col-xl-4"><img src="../../static/img/root/twitter.png" alt="Twitter" loading="lazy">
														</div>
			...
			<div class="vlt-section pp-scrollable" data-anchor="Testimonials">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<!--Ken Burn Effect-->
						<div class="vlt-section__ken-burn-background"><img src="../../static/img/testimonials.jpg" alt=""></div>
						<div class="container">
						...
						<div class="container">
							...
							<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.1s; animation-duration:700ms;">
								<ul class="vlt-partners">
									<li><img src="../../static/img/root/logo-01.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-02.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-03.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-04.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-05.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-06.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-07.png" alt="" loading="lazy"></li>
									<li><img src="../../static/img/root/logo-08.png" alt="" loading="lazy"></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="vlt-section pp-scrollable" data-anchor="Contact">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<!--Ken Burn Effect-->
						<div class="vlt-section__ken-burn-background"><img src="../../static/img/contact.jpg" alt=""></div>
						<div class="container">
							<div class="row">
								<div class="col-xl-4">
									<!--Animated Block-->
